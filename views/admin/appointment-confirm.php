                                    ...
                                    <div class="filter-container">
                                        ...
                                        <form>
                                            <select class="select2" name="specialty"
                                                ...
                                                <option value="All"
                                                    <?php echo($specialtySelected == 'All' ? 'selected' : ''); ?>>
                                                    Tất cả dịch vụ
                                                </option>
                                                <?php
                                    ...
                                    <div class="filter-container">
                                        ...
                                        <form>
                                            <select class="select2" name="doctor"
                                                style="height: 50px; border-color: #cac9c9; padding: 10px; width:250px ">
                                                <option value="All"
                                                    <?php echo($doctorSelected == 'All' ? 'selected' : ''); ?>>
                                                    Tất cả nhân viên
                                                </option>
                                                <?php
                                ...
                                <div class="col-3 table-filters pb-0">
                                    ...
                                    <div class="filter-container">
                                        <div class="row">
                                            <div class="col-12">
                                                <button id="button"
                                                    style="background-color: #D25B33!important; color: white"
                                                    class="btn form-control">Tìm kiếm</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="noSwipe">
                                    ...
                                    foreach ($listAppointments as $appointment): ?>
                                        ...
                                        ?>">
                                                ...
                                                <td class="cell-detail milestone" data-project="Bootstrap">
                                                    <span
                                                        class="completed"><?php echo htmlspecialchars($appointment['patient_dob']); ?></span>
                                                ...
                                                <td class="milestone">
                                                    <div><?php echo htmlspecialchars($appointment['patient_phone']); ?>
                                                    </div>
                                                    <span
                                                        class="version"><?php echo htmlspecialchars($appointment['patient_email']); ?></span>
                                                ...
                                                <td class="cell-detail">
                                                    <span
                                                        class="date"><?php echo date('H:i', strtotime($appointment['time_slot'])); ?></span>
                                                    <span class="cell-detail-description">
                                                        <?php
                                                ...
                                                ?>
                                                    <div
                                                        style="width: 150px; height: 35px; color: black; line-height: 35px;
                                    ...
                                    <div class="row be-datatable-footer"
                                        style="position: fixed; bottom: 0; right: 1.6%; left: 16.8%">
                                        <div class="col-sm-10 dataTables_paginate" id="pagination"
                                            ...
                                            ?>
                                                <ul class="pagination">
                                                    <li
                                                        class="page-item <?php if ($currentPage == 1) echo 'disabled'; ?>">
                                                        <a class="page-link"
                                                            href="?<?php echo $newQueryString; ?>&page=1"
                                                            aria-label="First">
                                                    ...
                                                    <li
                                                        class="page-item <?php if ($currentPage == 1) echo 'disabled'; ?>">
                                                        <a class="page-link"
                                                            href="?<?php echo $newQueryString; ?>&page=<?php echo max(1, $currentPage - 1); ?>"
                                                            aria-label="Previous">
                                                            <span aria-hidden="true">&lt;</span>
                                                        </a>
                                                    </li>
                                                ...
                                                ?>
                                                    <li
                                                        ...
                                                        <a class="page-link"
                                                            href="?<?php echo $newQueryString; ?>&page=<?php echo min($totalPages, $currentPage + 1); ?>"
                                                            aria-label="Next">
                                                            <span aria-hidden="true">&gt;</span>
                                                        </a>
                                                    </li>
